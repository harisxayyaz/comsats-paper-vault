    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-white text-black">
      <main className="flex flex-col items-center justify-center flex-1 p-5 text-center">
        ...
        <button
          ...
          className="flex items-center gap-1 text-white animate-fadeIn justify-center hover:justify-between hover:pl-5 hover:pr-5 bg-green-700 w-36 h-10 mt-5 rounded-xl hover:bg-green-900 hover:border-white hover:border-2 transition-all duration-300"
        >
